        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px', marginTop: '20px', alignItems: 'start' }}>
          {(() => {
            ...
            return paginatedEmployees.map((emp: any) => {
              ...
              if (roleFilter === 'ALL') {
                if (!emp.isActive) {
                  if (lastRole !== 'INACTIVE') { dividerHeader = 'Inactive Accounts'; lastRole = 'INACTIVE'; }
              ...
              return (
                <React.Fragment key={emp.id}>
                  {dividerHeader && (
                    <div style={{ gridColumn: '1 / -1', display: 'flex', alignItems: 'center', gap: '16px', marginTop: '24px', marginBottom: '12px', width: '100%' }}>
                      <h4 style={{ margin: 0, fontSize: '14px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>
                        {dividerHeader}
                      </h4>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                          <div style={{
                            ...
                            fontWeight: 'bold', color: emp.isActive ? 'var(--accent)' : '#9CA3AF',
                          ...
                          {(employeeRole === 'OWNER' || (employeeRole === 'ADMIN' && emp.role === 'STAFF')) && (
                            <div style={{ display: 'flex', gap: '6px', marginTop: '2px' }}>
                              <button
                                ...
                                style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '2px', color: 'var(--text-secondary)', transition: 'color 0.2s' }}
          ...
          <div className="inner-core" style={{ padding: '32px' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div className="form-group">
                ...
                {employeeRole !== 'OWNER' ? (
                  <select value="STAFF" disabled style={{ cursor: 'not-allowed', opacity: 0.6, backgroundColor: 'var(--bg-secondary)', pointerEvents: 'none' }}>
